...
<body >
    <div id="app">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                               @if (auth()->user()->email != 'admin@admin.com')
                                {{-- ini untuk validasi jika login sbg admin, maka tidak akan menampilkan button cart              --}}
                                    <li class="nav-item" >
                                        <div class="px-2">
        ...
        <div class="footer bg-dark text-center fixed-bottom" style="padding-top: 10px;"><p> Copyright &#169; 2020 | Bayu Ardana - 2201836135 & Vincent Immanuel - 2201798023 </p></div>
